...
let ValidCases =
    [
        ...
        TestCaseData([Function "floor"; Lpar; Number 2.0; Rpar])
        TestCaseData([Function "floor"; Lpar; Number 2.0; Comma; Number 2.0; Rpar])
        TestCaseData([Function "floor"; Lpar; Word "x"; Assign; Number 2.0; Comma; Word "x"; Assign; Number 2.0; Rpar])
        TestCaseData([Function "floor"; Lpar; Function "mod"; Lpar; Number 3.0; Comma; Number 4.0; Rpar; Comma; Word "x"; Assign; Number 2.0; Rpar])
        TestCaseData([Function "floor"; Lpar; Word "x"; Assign; Number 2.0; Comma; Word "x"; Assign; Number 2.0; Rpar; Plus; Number 1.0])
